...
{
    public static class AdminDetailedSearchValidation
    {
        ...
        public static bool IsValidOwner(object argObj, StringBuilder feedback)
        {
            if (argObj == null)
            {
                feedback.Append("Məhsulun sahibi seçilməlidir\n");
                return false;
            }

            return true;
        }
        public static bool IsValidProductStatus(object argObj, StringBuilder feedback)
        {
            if (argObj == null)
            {
                feedback.Append("Məhsulun statusu seçilməlidir\n");
                return false;
            }
